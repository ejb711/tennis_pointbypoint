...
Incorporates improvements for:
  ...
  - Running two simulation sets – one with initial settings and one with user-supplied alternative (comparison) settings – and comparing their results.

Comparison variables:
  - Enter Max Bet Absolute [default: 400]
  - Enter Server Bet Multiplier [default: 3.0]
  - Enter Receiver Bet Multiplier [default: 2.0]
  - Enter Initial Betting Sequence (e.g. SSSRRR) [default: SSSRRR]
  - Enter Tie favored pick (S or R) [default: S]
  - Enter Advantage favored pick (A=advantage, S=server, R=receiver) [default: A]
"""
...
def main():
    ...
    print(f"Maximum Drawdown: Mean: {baseline_max_drawdowns.mean():.2f} | Median: {np.median(baseline_max_drawdowns):.2f} | Std: {baseline_max_drawdowns.std():.2f} | Min: {baseline_max_drawdowns.min():.2f} | Max: {baseline_max_drawdowns.max():.2f}")
    ...
    if compare_choice.startswith('y'):
        ...
        comp_INITIAL_SEQUENCE = prompt_for_string("Enter Initial Betting Sequence (e.g. SSSRRR)", "SSSRRR")
        comp_TIE_FAVORED = prompt_for_string("Enter Tie favored pick (S or R)", "S")
        comp_ADVANTAGE_FAVORED = prompt_for_string("Enter Advantage favored pick (A=advantage, S=server, R=receiver)", "A")
        ...
        print(f"Maximum Drawdown: Mean: {comp_max_drawdowns.mean():.2f} | Median: {np.median(comp_max_drawdowns):.2f} | Std: {comp_max_drawdowns.std():.2f} | Min: {comp_max_drawdowns.min():.2f} | Max: {comp_max_drawdowns.max():.2f}")
